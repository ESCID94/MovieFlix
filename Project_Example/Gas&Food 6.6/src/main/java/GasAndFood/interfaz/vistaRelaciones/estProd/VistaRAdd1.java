...
public class VistaRAdd1 extends JFrame {
	
	private Controlador control;

	public VistaRAdd1(Controlador controlador) {
		...
		alimento.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				VistaRAdd vistaraddA = new VistaRAdd(control);
			}
		});
		
		gasolina.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VistaRAddG vistaraddG = new VistaRAddG(control);
